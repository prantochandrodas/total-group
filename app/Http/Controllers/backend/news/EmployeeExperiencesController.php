...
class EmployeeExperiencesController extends Controller
{
    public function index()
    {
        ...
        return view('backend.employee_experience.index', compact('application'));
    }
    ...
    public function getdata(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = EmployeeEngagement::with('images')->orderBy('created_at', 'desc')->get();
    ...
    {
        $application = Application::first();
        return view('backend.employee_experience.create', compact('application'));
    }
