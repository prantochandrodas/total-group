...
<div class="app-container container-fluid">
    <div style="background-color: #f0f0f0; padding: 20px;">
        <h2 style="text-align: center;">Edit Management-Members </h2>
    </div>

    <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
        <form method="POST" action="{{ route('management-members.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            {{-- designation field  --}}
            <div class="form-group">
                <label for="designation" class="mb-2 fs-5">Designation:</label>
