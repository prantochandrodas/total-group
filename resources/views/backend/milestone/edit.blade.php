...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Update-Milestone</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1" style="padding: 0">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Update-Milestone</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div class="app-container container-fluid">
    ...
    <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
        <form method="POST" action="{{ route('milestones.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
          
            {{-- milestones field  --}}
            <div class="form-group">
                <label for="milestones" class="mb-2 fs-5">Milestones:</label>
                <input type="text" class="form-control mb-2" id="milestones" name="milestones"
            ...
            <div>
                ...
                <div>
                    @foreach ($milestoneImage as $image)
