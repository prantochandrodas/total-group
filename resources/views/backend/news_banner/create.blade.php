   ...
   <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container  d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">News-Banner</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1" style="padding: 0">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">News-Banner</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<!--end::Toolbar-->
    ...
    <div class="container-fluid">
        <div style="background-color: #f0f0f0; padding: 20px;">
            <h2 style="text-align: center;">Create News-Banner Post</h2>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
            <form method="POST" action="{{ route('news-banners.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                {{-- description start  --}}
                <div style="margin-bottom: 20px;">
                    <label for="description" style="display: block; margin-bottom: 5px;" class="h5">Description:</label>
